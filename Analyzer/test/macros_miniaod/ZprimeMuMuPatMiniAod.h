...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("CMSSW803_MC_DYtoMuMu800to1400_13TeV_pattuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("CMSSW803_MC_DYtoMuMu800to1400_13TeV_pattuple.root");
      }
