...
mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_Full_CMSSW803_Data_2016_Run2016D-Collisions16-271036-276811-tree.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_Full_CMSSW803_Data_2016_Run2016D-Collisions16-271036-276811-tree.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_Full_CMSSW803_Data_2016_Run2016D-Collisions16-271036-276811-tree_cand.txt
