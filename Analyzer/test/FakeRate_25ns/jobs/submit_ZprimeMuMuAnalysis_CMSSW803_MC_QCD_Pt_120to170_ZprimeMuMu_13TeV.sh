...
./RunZprimeMuMuAnalysis_FR bkg sig_input.txt 1 bkg_input_7.txt 1 data_input.txt 1 BARI NO Spring16 >& ${workdir}/RunZprimeMuMuAnalysis_FR.log

mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_CMSSW803_MC_QCD_Pt_120to170_ZprimeMuMu_13TeV.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_CMSSW803_MC_QCD_Pt_120to170_ZprimeMuMu_13TeV.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_CMSSW803_MC_QCD_Pt_120to170_ZprimeMuMu_13TeV_cand.txt
