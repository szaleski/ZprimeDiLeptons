...
./RunZprimeMuMuAnalysis_FR bkg sig_input.txt 1 bkg_input_29.txt 1 data_input.txt 1 BARI NO Spring16 >& ${workdir}/RunZprimeMuMuAnalysis_FR.log

mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_CMSSW8012_MC_reHLT_DYtoMuMu2300to3500_13TeV_tree.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_CMSSW8012_MC_reHLT_DYtoMuMu2300to3500_13TeV_tree.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_CMSSW8012_MC_reHLT_DYtoMuMu2300to3500_13TeV_tree_cand.txt
