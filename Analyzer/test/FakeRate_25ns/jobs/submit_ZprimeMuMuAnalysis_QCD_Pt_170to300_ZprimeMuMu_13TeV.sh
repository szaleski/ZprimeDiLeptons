...
mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_QCD_Pt_170to300_ZprimeMuMu_13TeV.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_QCD_Pt_170to300_ZprimeMuMu_13TeV.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_QCD_Pt_170to300_ZprimeMuMu_13TeV_cand.txt
