...
mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_CMSSW803_MC_DYtoMuMu6000toInf_13TeV_pattuple.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_CMSSW803_MC_DYtoMuMu6000toInf_13TeV_pattuple.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_CMSSW803_MC_DYtoMuMu6000toInf_13TeV_pattuple_cand.txt
