...
mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_Data_2016_Run2016B-Collisions16-275125-275783.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_Data_2016_Run2016B-Collisions16-275125-275783.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_Data_2016_Run2016B-Collisions16-275125-275783_cand.txt
