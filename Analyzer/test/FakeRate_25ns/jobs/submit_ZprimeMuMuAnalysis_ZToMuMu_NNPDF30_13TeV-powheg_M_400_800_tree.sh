...
mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_ZToMuMu_NNPDF30_13TeV-powheg_M_400_800_tree.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_ZToMuMu_NNPDF30_13TeV-powheg_M_400_800_tree.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_ZToMuMu_NNPDF30_13TeV-powheg_M_400_800_tree_cand.txt
