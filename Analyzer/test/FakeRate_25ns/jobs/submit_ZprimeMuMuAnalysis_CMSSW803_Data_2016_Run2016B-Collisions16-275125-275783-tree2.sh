...
./RunZprimeMuMuAnalysis_FR data sig_input.txt 1 bkg_input.txt 1 data_input_7.txt 1 BARI 2016 NO >& ${workdir}/RunZprimeMuMuAnalysis_FR.log

mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_CMSSW803_Data_2016_Run2016B-Collisions16-275125-275783-tree2.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_CMSSW803_Data_2016_Run2016B-Collisions16-275125-275783-tree2.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_CMSSW803_Data_2016_Run2016B-Collisions16-275125-275783-tree2_cand.txt
