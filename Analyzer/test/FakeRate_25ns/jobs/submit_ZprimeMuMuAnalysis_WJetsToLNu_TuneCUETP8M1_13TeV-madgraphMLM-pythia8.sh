...
mv -f ${workdir}/RunZprimeMuMuAnalysis_FR.log /lustre/cms/store/user/defilip/ZprimeAnalysis/80X/jobs/jobsZprimeMuMu_FR/output_WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.log
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV.root     ${savedir}/output_WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root
mv -f ${workdir}/CMSSW803-Analyse_ZprimeToMuMu_13TeV_cand.txt ${savedir}/output_WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_cand.txt
