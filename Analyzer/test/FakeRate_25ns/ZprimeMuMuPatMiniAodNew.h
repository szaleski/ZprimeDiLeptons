...
//                       17/5/2016                             = 
//==============================================================
#ifndef ZprimeMuMuPatMiniAodNew_h
#define ZprimeMuMuPatMiniAodNew_h
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include "TFile.h"
...
public :
   ...
   ZprimeMuMuPatMiniAodNew(TTree *tree=0);
   virtual ~ZprimeMuMuPatMiniAodNew();
   ...
   */
   ...
   bool isPassHLT();
   void DrawBTaggingDiscriminator();
   bool BTaggingDiscriminator();
...
#ifdef ZprimeMuMuPatMiniAodNew_cxx
ZprimeMuMuPatMiniAodNew::ZprimeMuMuPatMiniAodNew(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("TTTo2L2Nu_13TeV-powheg-tree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("TTTo2L2Nu_13TeV-powheg-tree.root");
      }
...
ZprimeMuMuPatMiniAodNew::~ZprimeMuMuPatMiniAodNew()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ZprimeMuMuPatMiniAodNew::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ZprimeMuMuPatMiniAodNew::LoadTree(Long64_t entry)
{
...
void ZprimeMuMuPatMiniAodNew::Init(TTree *tree)
{
...
Bool_t ZprimeMuMuPatMiniAodNew::Notify()
{
...
void ZprimeMuMuPatMiniAodNew::Show(Long64_t entry)
{
...
Int_t ZprimeMuMuPatMiniAodNew::Cut(Long64_t entry)
{
...
#endif // #ifdef ZprimeMuMuPatMiniAodNew_cxx
