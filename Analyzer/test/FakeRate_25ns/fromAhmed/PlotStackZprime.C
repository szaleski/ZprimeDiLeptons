...
PlotStackZprime::PlotStackZprime(){
  ...
  inputfile="filelist_zprime_ExpressPhysics_2016_Spring16_AN_Bari.txt";
  ...
  //std::string histolabel = "h1_NJets";
...
//   Color_t h400Color = kRed;
  ...
  hframe= new TH2F("hframe","hframe",80,50.,1000.,500,0.0005,3000.);// di-mu  mass nrebin=10  GeV
  hframe2= new TH2F("hframe2","hframe2",80,50.,1000.,1000, 0.5, 2.);// di-mu mass


  if (histlabel.find("ZprimeRecomass")<10 && nRebin==20){
    hframe= new TH2F("hframe","hframe",80,50.,13000.,500,0.0000005,3000.);// di-mu  mass nrebin=10  GeV
    hframe2= new TH2F("hframe2","hframe2",80,50.,13000.,1000, 0.5, 2.);// di-mu mass
  }

  if (histlabel.find("ZprimeRecomass")<10 && nRebin==5){
    hframe= new TH2F("hframe","hframe",80,50.,1000.,500,0.0005,1500.);// di-mu  mass nrebin=5  GeV
    hframe2= new TH2F("hframe2","hframe2",80,50.,700.,1000, 0.5, 2.);// di-mu mass
  }   

  if (histlabel.find("ZprimeRecomass")<10 && nRebin==1){
    hframe= new TH2F("hframe","hframe",100,60.,180.,500,0.4,350.);// mZ mumu
    hframe2= new TH2F("hframe2","hframe2",100, 60., 180., 1000, 0.5, 2.);// mZ mumu
  }

  if (histlabel.find("h1_Den_Pt")<10 && nRebin==10){
    hframe= new TH2F("hframe","hframe",100,50.,1000.,500,0.1,3000000050.);// pT in control region
    hframe2= new TH2F("hframe2","hframe2",100,50., 1000., 1000, 0.5, 2.);// pT in control region
  }
  if (histlabel.find("h1_Num_Pt")<10 && nRebin==10){
    hframe= new TH2F("hframe","hframe",100,50.,1000.,500,0.01,100000050.);// pT in control region
    hframe2= new TH2F("hframe2","hframe2",100,50., 1000., 1000, 0.5, 2.);// pT in control region
  }
  ...
  if (histlabel.find("h1_Njets")<10 && nRebin==1){
    hframe= new TH2F("hframe","hframe",100,-0.5,4.5,500,0.0001,100000000050.);// MET_Sign in control region
    hframe2= new TH2F("hframe2","hframe2",100,-0.5, 4.5, 1000, 0.5, 2.);// MET_Sign in control region
  }
  ...
  if (histlabel.find("hPFMET_8")<10){
    ...
    hframe2= new TH2F("hframe2","hframe2",1000, 0., 500., 1000, 0.5, 2.);// PFMET
  }
  ...
  if (histlabel.find("ZprimeRecomass")<10) hframe->SetXTitle("m_{#mu^{+}#mu^{-}} [GeV]");
  ...
  TH1F *htotalHisto_noQCD = new TH1F("htotalHisto_noQCD", "htotalHisto_noQCD", Nbins, Xmin, Xmax);
  htotalHisto_noQCD->SetLineColor(2);
  htotalHisto_noQCD->SetFillColor(2);
  ...
  for ( int datasetId=Vdatasetnamebkg.size()-1; datasetId >=0; datasetId--){  
	...
	if(datasetnamebkg.find(temp) <200 && (datasetnamebkg.find(whichenergy) < 200 && datasetnamebkg.find("DYtoMuMu120to200_13TeV")<200)){
    ...
    //
    else if(datasetnamebkg.find("ZZ") < 200){
    ...
    //else if( datasetnamebkg.find("_ZZTo") < 200 ){
      ...
      else if (whichsample.find("13TeV")<200) sprintf(temp,"%s/ZZ%s",histosdir.c_str(),whichsample.c_str());
	...
	//legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F");  
      ...
      else if(datasetnamebkg.find("QCD_Pt") < 200 && datasetnamebkg.find("QCD_Pt") < 200 ){
	...
	//sprintf(temp,"%s/output_QCD_Pt_10to15",histosdir.c_str());
        sprintf(temp,"%s/QCD_Pt_1000to1400",histosdir.c_str());
	...
	//legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F"); 
      ...
      else if(datasetnamebkg.find("tbarW") < 200 ||  datasetnamebkg.find("tbarW") < 200 ){
	...
	char temp[328];
	sprintf(temp,"%s/tw",histosdir.c_str());
    ...
    else if (whichsample.find("13TeV")<200) sprintf(tempp,"%s/ZZ%s",histosdir.c_str(),whichsample.c_str());    
    ...
    if(datasetnamebkg.find(tempp) < 300) {
      ...
      htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_ZZ);
    }
    else {
	 ...
	 htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_ggH); 
       }
       if(datasetnamebkg.find(temppp) < 200 && (
	 ...
	 htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_VH); 
       }
       if(datasetnamebkg.find(temppp) < 200 && (
	 ...
	 htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_ttH);
       }
       if(datasetnamebkg.find(temppp) < 200 && (
	 ...
	 htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_VBFH); 
       }
	 ...
	 if(datasetnamebkg.find(temppp) < 200 && (
						  ...
						  datasetnamebkg.find("DYtoMuMu800to1400_13TeV_pattuple") <200 
						 ) 
	    )  {
	   htotal->Add(hfourlepbestmass_4l_afterSel_new_DY);
	   htotalHisto->Add(hfourlepbestmass_4l_afterSel_new_DY);
	   htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_DY);
	 }
       }
	 ...
	 if(datasetnamebkg.find(temppp) < 200 && datasetnamebkg.find("output_DYlightJetsToLL_TuneZ2_M-50") < 200 )  {
	   ...
	   htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_DYlight);
	 }
	 if(datasetnamebkg.find(temppp) < 200 && datasetnamebkg.find("output_DYbbJetsToLL_TuneZ2_M-50") < 200 )  {
	   ...
	   htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_DYbb);
	 }
	 if(datasetnamebkg.find(temppp) < 200 && datasetnamebkg.find("output_DYccJetsToLL_TuneZ2_M-50") < 200 )  {
	   ...
	   htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_DYcc);
	 }
       }

       if(datasetnamebkg.find(temppp) < 200 && (
	  datasetnamebkg.find("WW") < 200 || 
	  (datasetnamebkg.find("WW") < 200 && datasetnamebkg.find(whichenergy.c_str())<200)
	  )
	  )  { 
	 ...
	 htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_WW); 
       ...
       if(datasetnamebkg.find(temppp) < 200 && (
					       datasetnamebkg.find("WZ") < 200 ||
					       (datasetnamebkg.find("WZ") < 200 && datasetnamebkg.find(whichenergy.c_str())<200)
					       ) 
	  )  {
	 ...
	 htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_WZ);  
       ...
       if(datasetnamebkg.find(temppp) < 200 && (
					       ...
					       (datasetnamebkg.find("TTbar") < 200 && datasetnamebkg.find(whichenergy.c_str())<200)
					       )
	  )  {
	 htotal->Add(hfourlepbestmass_4l_afterSel_new_TT);                        
	 htotalHisto->Add(hfourlepbestmass_4l_afterSel_new_TT);   
	 htotalHisto_noQCD->Add(hfourlepbestmass_4l_afterSel_new_TT);
       }
       if(datasetnamebkg.find(temppp) < 200 && (
	 ...
	 htotalHisto->Add(hfourlepbestmass_4l_afterSel_new_qcdBC);
       ...
       if(datasetnamebkg.find(temppp) < 200 && datasetnamebkg.find("QCD_Pt_1000to1400") < 200 ){
	 
	 
	 if (correctQCD){
	   if (histlabel.find(histlabel.c_str())<10) {
	     cout << "Correcting the QCD histogram:" << endl;
	     char QCDkfactorname[300];
	     sprintf(QCDkfactorname,"QCDkfactor_%s.root",histlabel.c_str());	   
	     TFile *file1=NULL;
	     file1 = TFile::Open(QCDkfactorname); 
	     TH1F *QCDCorrFactor = (TH1F*)file1->Get("htotalHistoQCDCorr");
	     QCDCorrFactor->SetFillStyle(1001); 
	     QCDCorrFactor->SetFillColor(kPink);
	     QCDCorrFactor->SetLineColor(1);
	     QCDCorrFactor->SetFillColor(kTeal-2);
	     QCDCorrFactor->SetLineWidth(1);
	     htotal->Add(QCDCorrFactor);
	     htotalHisto->Add(QCDCorrFactor);    	 
	   }
	 }
	 else {
       ...
       if(datasetnamebkg.find(temppp) < 200 && datasetnamebkg.find("singletop") < 200 && datasetnamebkg.find("singletop") < 200 ){     	 
  ...
  // Normalize histograms to data
  //htotal->Scale(double(htotaldata->GetEntries()/hotal->Integral(0,-1.)));
  //htotalHisto->Scale(double(htotaldata->Integral(0,-1)/htotalHisto->Integral(0,-1)));
  //cout << "Normalization=" << htotalHisto->Integral(0,-1) << " " << htotaldata->Integral(0,-1) << endl;
  TH1F *fraction_noQCD = new TH1F("fraction_noQCD", "fraction_noQCD", Nbins, Xmin, Xmax);
  //for (int nbins=1;nbins<=fraction_noQCD->GetNbinsX(); nbins++){
  //  if (htotalHisto->GetBinContent(nbins)>0.) fraction_noQCD->SetBinContent(nbins,htotalHisto_noQCD->GetBinContent(nbins)/htotalHisto->GetBinContent(nbins));
  //  else fraction_noQCD->SetBinContent(nbins,1.);
  //}
  fraction_noQCD->Divide(htotalHisto_noQCD,htotalHisto,1.,1.);


  // Building the correction factor for QCD
  TH1F *Corr = new TH1F("Corr", "Corr", Nbins, Xmin, Xmax);
  TH1F *htotalHistoQCDCorr = new TH1F("htotalHistoQCDCorr", "htotalHistoQCDCorr", Nbins, Xmin, Xmax);
  THStack *htotalCorrWithQCD=new THStack("htotalCorrWithQCD",""); 
  TH1F *htotalHistoCorrWithQCD= new TH1F("htotalHistoCorrWithQCD", "htotalHistoCorrWithQCD", Nbins, Xmin, Xmax);

  if ( correctQCD){
    if (histlabel.find(histlabel.c_str())<10){
      
      for (int nbins=1;nbins<=htotaldata->GetNbinsX(); nbins++){
	if(hfourlepbestmass_4l_afterSel_new_qcd->GetBinContent(nbins)>0. && htotaldata->GetBinContent(nbins)>0.) Corr->SetBinContent(nbins,double( (htotaldata->GetBinContent(nbins)-htotalHisto_noQCD->GetBinContent(nbins))/hfourlepbestmass_4l_afterSel_new_qcd->GetBinContent(nbins)));
	else Corr->SetBinContent(nbins,1.);
	if(hfourlepbestmass_4l_afterSel_new_qcd->GetBinContent(nbins)>0. && htotaldata->GetBinContent(nbins)>0.) cout << htotaldata->GetBinContent(nbins) << " " << htotalHisto_noQCD->GetBinContent(nbins) << " " << hfourlepbestmass_4l_afterSel_new_qcd->GetBinContent(nbins)<< endl;
	cout << "Correction factor for QCD bin content= " << nbins << " " << Corr->GetBinContent(nbins) << endl;
      }
      
      //TH1F *htotalHistoQCDCorr = new TH1F("htotalHistoQCDCorr", "htotalHistoQCDCorr", Nbins, Xmin, Xmax);
      for (int nbins=1;nbins<=hfourlepbestmass_4l_afterSel_new_qcd->GetNbinsX(); nbins++){
	htotalHistoQCDCorr->SetBinContent(nbins,double(Corr->GetBinContent(nbins)*hfourlepbestmass_4l_afterSel_new_qcd->GetBinContent(nbins)));
      }
      htotalHistoQCDCorr->SetLineColor(4);
      htotalHistoQCDCorr->SetFillColor(4);
      
      //THStack *htotalHistoCorrWithQCD=new THStack("htotalHistoCorrWithQCD",""); 
      
      htotalCorrWithQCD->Add(htotalHisto_noQCD);
      htotalCorrWithQCD->Add(htotalHistoQCDCorr);
      htotalHistoCorrWithQCD->Add(htotalHisto_noQCD);
      htotalHistoCorrWithQCD->Add(htotalHistoQCDCorr);
      
      // Building the ratio with QCD corrected in 
      for (int nbins=1;nbins<=htotaldata->GetNbinsX(); nbins++){
	...
	if (htotalHistoCorrWithQCD->GetBinContent(nbins)>0.) {
	  htotalHistoRatio->SetBinContent(nbins,double(htotaldata->GetBinContent(nbins)/htotalHistoCorrWithQCD->GetBinContent(nbins)));
	  ...
	  htotalHistoRatio->SetBinError(nbins,double(sqrt( 
							  (1./(htotalHistoCorrWithQCD->GetBinContent(nbins)*htotalHistoCorrWithQCD->GetBinContent(nbins)))*htotaldata->GetBinContent(nbins) +
							  (htotaldata->GetBinContent(nbins)*htotaldata->GetBinContent(nbins)/pow(htotalHistoCorrWithQCD->GetBinContent(nbins),4))
							  *htotalHistoCorrWithQCD->GetBinContent(nbins) 						      
							   )));
	  cout << "Histo ratio= " << htotalHistoRatio->GetBinContent(nbins) << endl;
  ...
  for ( int datasetIdSig=Vdatasetnamesig.size()-1; datasetIdSig >=0; datasetIdSig--){  
	...
	hfourlepbestmass_4l_afterSel_new_signal126->SetBinContent(nbins,double(bincont126[nbins-1]));
      ...
      if (datasetnamesig.find(temp)< 100 && datasetnamesig.find("output_SMHiggsToZZLTo4L_M-200") < 180 ) {
  ...
  */
  ...
  if (histlabel.find("ZprimeRecomass")<10 ) 
    outputyields << "m_DM=1 " << hfourlepbestmass_4l_afterSel_new_Zprime5000->Integral(0,-1) << " +/- " << errorH125 << endl;  
...
//   c1->SaveAs(saveasrootzoom.c_str()/*"plots/hfourlepbestmass_4l_afterSel_new_m4l.eps"*/);
  ...
  if (nRebin==10 && histlabel.find("hM4l_8")<10){
    ...
    std::string saveasroot = useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_log.root" : "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+".root";
...
//     c1->SaveAs(saveasroot.c_str()/*"plots/hfourlepbestmass_4l_afterSel_new_m4l.root"*/);
  }
  ...
  if (correctQCD){
    if (histlabel.find(histlabel.c_str())<10){
      char QCDkfactorname[300];
      sprintf(QCDkfactorname,"QCDkfactor_%s.root",histlabel.c_str());
      TFile *file0 = new TFile(QCDkfactorname, "RECREATE");
      file0->cd();
      TCanvas *c2 = new TCanvas("c2","c2",600,800);  
      c2->cd();
      c2->SetLogy(1);
      c2->SetTicks(1,1);
      // Plotting MC corrected for QCD matching data
      hframe->Draw();
      htotalHistoCorrWithQCD->Draw("Hsame");
      //htotaldata->Draw("EPsame");
      gr->Draw("EPsame");
      htotalHistoQCDCorr->Write();
      htotalHisto_noQCD->Write();
      file0->Write();
      file0->Close();
    }
  }
...
void PlotStackZprime::setSamplesNames4l()
{
  ...
  if (inputfile.find("2016")<100) { 
    whichenergy="13TeV";
    whichsample="2016MiniAod";
  }
  ...
  while(std::getline(infile,inputfilename)){
    ...
    if(inputfilename.find("_DoubleMu_")<200){ // as many times as it occurs in the input file
      Vdatasetnamedata.push_back(inputfilename);
      Vlabeldata.push_back("DoubleMu - 2011+2012");
    ...
    if(inputfilename.find("Data_2016")<200){ // as many times as it occurs in the input file
      Vdatasetnamedata.push_back(inputfilename);
      Vlabeldata.push_back("Data_2016");
      Vxsectiondata.push_back(1.); //pb
    }     
    ...
    // BACKGROUND from other sources
      ...
      //Vdatasetnamebkg.push_back(inputfilename);
       ...
       // qqZZ to 4l
      if(inputfilename.find("ZZ")<200 || inputfilename.find("ZZ")<200){	
	Vdatasetnamebkg.push_back(inputfilename);
...
//       } 
      ...
      if(inputfilename.find("DYtoMuMu")<200){//ZToMuMu_NNPDF30_13TeV-powheg_M
	Vdatasetnamebkg.push_back(inputfilename);
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_1000to1400");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_10to15");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_120to170");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_1400to1800");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_15to30");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_170to300");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_1800to2400");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_2400to3200");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_300to470");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_30to50");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_3200toInf");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_470to600");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_50to80");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_5to10");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_600to800");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("QCD_Pt_80to120");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kTeal-2);
      }
	...
	Vcolorbkg.push_back(kViolet);
      ...
      if(inputfilename.find("singletop")<200 || inputfilename.find("singletop")<200){
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("singletop");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kViolet);
      } 
      
      // T_TuneZ2_tW-channel_8TeV-madgraph
      if(inputfilename.find("tW")<200 || inputfilename.find("tW_")<200 ){
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("tW");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kViolet);
      } 

      // Tbar_TuneZ2_s-channel_8TeV-madgraph
      if(inputfilename.find("s-channel_antitop")<200 || inputfilename.find("Tbar_TuneZ2_s-channel")<200 ){
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("Tbar_TuneZ2_s-channel");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kViolet);
      } 
      
      // Tbar_TuneZ2_t-channel_8TeV-madgraph
      if(inputfilename.find("t-channel_antitop")<200 || inputfilename.find("Tbar_TuneZ2_t-channel")<200 ){
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("t-channel_antitop");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kViolet);
      } 
      
      // Tbar_TuneZ2_tW-channel-DR_8TeV-madgraph
      if(inputfilename.find("tbarW")<200 || inputfilename.find("tbarW_")<200 ){
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("tbarW");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kViolet);
      } 
