...
public :
   ...
   ZprimeMuMuPat(Char_t namechar_[300],TTree *tree=0,Double_t weight_=1.,string DATA_type_="DATA",string MC_type_="MC");
...
ZprimeMuMuPat::ZprimeMuMuPat(Char_t namechar_[300], TTree *tree,Double_t weight_,string DATA_type_,string MC_type_) : fChain(0) 
{
  ...
  if (tree == 0) {
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("CMSSW745_Data2015_ZprimeMuMu_13TeV_tree.root");
    if (!f || !f->IsOpen()) {
      f = new TFile("DYtoMuMu-MC-Mass6000to7500-CMSSW720-PYTH14-Trigger-tree.root");
    }
