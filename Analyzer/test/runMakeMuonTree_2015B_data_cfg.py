...
#'file:highestmass_251562_414_367325039.root'
#'file:fevt_256843_465_665539990.root'
...
process.HLTEle =cms.EDFilter("HLTHighLevel",
     ...
     #HLTPaths = cms.vstring("HLT_Mu45_eta2p1_v2","HLT_Mu50_v2"),
     HLTPaths = cms.vstring("HLT_Mu45_eta2p1_v2"),                              
...
process.maketreeMuon = cms.EDAnalyzer("MaketreeMuons",
    ...
    triggerFilter         = cms.vstring('hltL3fL1sMu16orMu25L1f0L2f16QL3Filtered45e2p1Q'),
    #triggerFilter         = cms.vstring('hltL3fL1sMu16orMu25L1f0L2f16QL3Filtered45e2p1Q','hltL3fL1sMu16orMu25L1f0L2f16QL3Filtered50Q'),
